    ...
    <div class="base-desc" :style="{opacity}">
      ...
      <div class="carbtn">
        ...
        <div class="link d-flex justify-content-center align-items-center;">
          <div><router-link to="#" v-text="design" ></router-link></div>
          <div :class="none"><router-link to="/details" v-text="details" ></router-link></div>
        </div>
        <!-- 页面底部指引图标 -->
...
/* 各个背景图 */
#home .box1{background-image:url('/home/CN-D-3.jpg');}
#home .box2{background-image:url('/home/Desktop-ModelS.jpg');}
#home .box3{background-image:url('/home/Desktop-ModelX.jpg');}
#home .box4{background-image:url('/home/Desktop-ModelY.jpg');}
#home .box5{background-image:url('/home/Desktop-SolarPanels.jpg');}
#home .box6{background-image:url('/home/Desktop-Accessories.jpg');}

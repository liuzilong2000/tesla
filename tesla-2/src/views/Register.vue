			...
			<div class="flex-column">
				...
				<div>
					...
					<div class="verification">
						...
						<p>请输入图片中的字符</p>
						<div>
							<input type="text" class="inp" :class='verificationFail' v-model='verificationValue'>
						</div>
...
export default {
    ...
    methods:{
		...
		login_btn(){
			...
			// 都通过判断验证
			if(myName&&mySurname&&myEmail&&myPwd&&myStatement&&myVerification){
				console.log('注册成功')
			}

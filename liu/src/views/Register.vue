...
export default {
	data(){
		return{
			...
			// 验证码数组
			verificationS:["/images/captcha.svg","/images/captcha1.svg","/images/captcha2.svg","/images/captcha3.svg","/images/captcha4.svg","/images/captcha5.svg","/images/captcha6.svg","/images/captcha7.svg","/images/captcha8.svg","/images/captcha9.svg"],
			// 随机数
			random:'',
			// 随机出现的验证码
			verificationL:'',
    ...
    methods:{
		...
		login_btn(){
			...
			// 都通过判断验证
			console.log(myName,mySurname,myEmail,myPwd)

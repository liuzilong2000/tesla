				...
				<div  class="header row no-gutters" >
					...
					<div class="h_middle col-xl-6 d-xl-flex d-none d-xl-block justify-content-center">
						<ul class="list-unstyled d-flex justify-content-center">
							...
							<li><a href="/powereall">POWERWALL</a></li>
						</ul>
					</div>
					...
					<div class="h_right col-xl-3 d-none d-xl-block">
						<ul class="list-unstyled  d-flex justify-content-end">
							<li><a href="/shopping">在线商城</a></li>
							<li v-if="this.$store.state.loginStatus !== 1"><a href="/login">TESLA 账户</a></li>
							<li v-else @click="logout_mutations"><a href="/login"><span>退出登录</span></a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div id="navbar"  class="container" :style="{width}">
			...
			<div class="inner-nav" :style="nav">
				<div>
					<!-- 屏幕尺寸大于1200时显示以下 -->
					<ul>
						<li><a href="javascript:;">认证二手车</a></li>
						<li><a href="javascript:;">车辆置换</a></li>
						<li><a href="javascript:;">ROADSTER</a></li>
						<li><a href="##">ENERGY</a></li>
						<li><a href="javascript:;">大客户计划</a></li>
						<li><a href="javascript:;">金融服务</a></li>
						<li><a href="javascript:;">如何充电</a></li>
						<li><a href="javascript:;">找到我们</a></li>
					...
					<el-collapse-transition>
						<ul v-show="!show3">
							...
							<li v-if="this.$store.state.loginStatus !== 1"><a href="/login">TESLA账户</a></li>
							<li v-else @click="logout_mutations"><a href=""><span>退出登录</span></a></li>
						</ul>
					</el-collapse-transition>
				</div>
			</div>

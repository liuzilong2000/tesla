<template>
  <div>
    <Details>
      ...
      <!-- ---------------------第四页------------------------------ -->
      <slot slot="box4Video"><video src="/images/MODELS/video/119ZLJ_range.mp4-2000_TSMBHB.mp4" muted="muted"  loop='loop' ref="box4autoplay"></video></slot>
...
export default {
  ...
  data(){
    return{
      ...
      box1Bgimg:'background-image:url("/images/MODELS/model-s@2x.jpg")',
      box2Bgimg:'background-image:url("/images/MODELS/safety-model-s-hero.png")',
      box3Bgimg:'background-image:url("/images/MODELS/model-s-performance.jpg")',
      box6Bgimg:'background-image:url("/images/MODELS/hero@2_1.jpg")',
      box7BigBgimg:'background-image:url("/images/MODELS/hero-high-viewport.jpg")',
      box8img:'/images/MODELS/MS-specs-desktop.jpg',
      box9img:'/images/MODELS/models@2.jpg',
    }
  },
  beforeMount(){ 
    if(window.innerWidth<420){
      this.box7BigBgimg = "background-image:url('/images/MODELS/hero-mobile@2_2.jpg')"
      this.box1Bgimg = 'background-image:url("/images/MODELS/model-s-mobile@2x.jpg")'
      this.box2Bgimg = 'background-image:url("/images/MODELS/model-s-hero-v2-mobile.jpg")'
      this.box3Bgimg = 'background-image:url("/images/MODELS/model-s-performance-mobile.jpg")'
    }
  },
  methods:{  
    // 第四屏视频
